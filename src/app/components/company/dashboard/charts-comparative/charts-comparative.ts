...
import { ChartColumn, ChevronDown, ChevronRight, LucideAngularModule } from 'lucide-angular';

@Component({
  selector: 'component-company-dashboard-charts-comparative',
  imports: [
    LucideAngularModule,
    CommonModule,
    RouterLink
  ],
  templateUrl: './charts-comparative.html',
})
export class ComponentCompanyDashboardChartsComparative {
